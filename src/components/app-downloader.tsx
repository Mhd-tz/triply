...
export default function AppDownloadBanner() {
    return (
        <section className="w-[80%] mx-auto px-4 py-4">
            <div className="relative overflow-hidden rounded-3xl border border-primary/80 px-8 py-8 flex items-center justify-between gap-6 min-h-[180px]">
                ...
                <div className="absolute top-4 right-[340px] h-24 w-24 rounded-full bg-primary/5 pointer-events-none" />
                <div className="absolute top-10 right-[300px] h-24 w-24 rounded-full bg-primary/5 pointer-events-none" />
                ...
                <div className="flex items-center gap-6 z-10 flex-1 min-w-0">
                    ...
                    {/* Divider */}
                    <div className="w-px h-35 bg-primary/50 shrink-0" />

                    {/* Text */}
                    <div className="flex flex-col gap-2 min-w-0">

                        <h2 className="font-heading font-bold text-black text-xl leading-tight">
                            Your whole trip,<br />synced to your pocket!
                        </h2>
                        ...
                        <div className="flex items-center gap-3 mt-1">
                            <a
                                href="#"
                                className="flex items-center gap-2 bg-black text-white text-[12px] font-bold px-4 py-2 rounded-xl hover:bg-black/90 transition-colors shadow-sm"
                            >
                            ...
                            <a
                                href="#"
                                className="flex items-center gap-2 border border-primary text-primary text-[12px] font-bold px-4 py-2 rounded-xl hover:bg-primary/90 hover:text-white transition-colors shadow-sm"
                            >
                                <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* ── Right: Phone mockups ──────────────────────── */}
                <div className="relative shrink-0 w-[220px] h-[160px] hidden md:block">
                    {/* Back phone */}
                    <PhoneMockup className="absolute right-0 top-0 w-[120px] opacity-60 rotate-6 translate-x-4 -translate-y-2" />
                    {/* Front phone */}
                    <PhoneMockup className="absolute right-10 bottom-0 w-[130px] -rotate-3" />
                </div>
            </div>
        </section>
    );
